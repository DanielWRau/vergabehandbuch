...
<!-- ==================== ENDE KAPITEL: Kapitel_01_Sprachmodelle_verstehen.md ==================== -->

<!-- ==================== KAPITEL: Kapitel_02_Strategie_und_erste_Schritte.md ==================== -->
...
**Was Sie sicher eingeben können:**
...
<!-- ==================== ENDE KAPITEL: Kapitel_04_Ausschreibungswerkstatt.md ==================== -->
...
Trotz bestem Vertragsmanagement kann es zu unvorhergesehenen Problemen kommen. Auch hier kann die KI ein wertvoller Partner sein, um einen kühlen Kopf zu bewahren und strategisch zu handeln. Entscheidend ist hierbei die **Gestaltung der Zusammenarbeit im Mensch-KI-System**. Die KI liefert die Analyse, der Mensch behält die **Autonomie und Kontrolle** über die Entscheidung.
...
**Der KI-gestützte Ansatz:** Wir nutzen die KI, um den Schriftsatz in Sekunden zu analysieren und die Grundlage für unsere Verteidigungsstrategie zu legen. Die KI agiert als Assistenzsystem, das die Fakten aufbereitet, während die juristische Bewertung und Strategieentwicklung beim Menschen verbleibt.
...
**Der KI-gestützte Ansatz:** Wir nutzen die KI als neutralen Sparringspartner, um Handlungsoptionen zu entwickeln und die Konsequenzen verschiedener Strategien abzuschätzen. Die KI hilft, alle relevanten Fakten zu berücksichtigen und einen strukturierten Entscheidungsprozess zu ermöglichen, ohne die finale Entscheidung vorwegzunehmen.
...
2.  **Wie gewährleisten wir die Sicherheit und Gebrauchstauglichkeit?** (Die Frage nach Datenschutz, Compliance und menschzentrierter Gestaltung)
...
## **7.2 Sicherheit, Compliance und Gebrauchstauglichkeit: Die entscheidenden Fragen an Ihre IT**

Sie müssen kein IT-Sicherheitsexperte sein, aber Sie müssen die richtigen Fragen stellen können. Wenn Ihre IT-Abteilung oder ein externer Dienstleister die Einführung eines KI-Systems vorschlägt, sollten Sie die folgenden Punkte klar und verständlich beantwortet bekommen. Diese Fragen helfen Ihnen, das Sicherheitskonzept zu durchdringen und die **menschzentrierte Gestaltung** der Lösung sicherzustellen.
...
6.  **Die "Gebrauchstauglichkeits-Frage": Wie wurde sichergestellt, dass das System für die Endanwender verständlich, effizient und zufriedenstellend zu bedienen ist?**
    *   **Hintergrund:** Eine technisch perfekte Lösung ist nutzlos, wenn sie von den Mitarbeitern nicht akzeptiert oder falsch bedient wird. **Gebrauchstauglichkeit (Usability)** und eine positive **Nutzererfahrung (User Experience)** sind entscheidend für den Erfolg.
    *   **Was Sie erwarten sollten:** Nachweise über einen **menschzentrierten Gestaltungsprozess**. Wurden die zukünftigen Nutzer in die Entwicklung einbezogen (z.B. durch Workshops, Interviews)? Wurden Prototypen mit echten Nutzern getestet? Ist die **Transparenz** des Systems gewährleistet, sodass der Nutzer versteht, was die KI tut und warum? Ist die **Kontrolle** jederzeit beim Menschen?

Eine überzeugende Antwort auf diese Fragen ist wichtiger als jede technische Spezifikation. Lassen Sie sich nicht mit Fachbegriffen abspeisen. Wenn ein IT-Verantwortlicher Ihnen diese Punkte nicht in einfachen Worten erklären kann, ist das Gesamtkonzept wahrscheinlich nicht ausgereift.
...
```mermaid
graph TD
    A[2024: KI als Assistenz] --> B(KI unterstützt Mensch);
    B --> C(Mensch trifft alle Entscheidungen);
    C --> D[2026: KI als Kollaborateur];
    D --> E(Mensch & KI arbeiten gemeinsam);
    E --> F(Mensch validiert & korrigiert);
    F --> G[2028: KI als Supervisor];
    G --> H(KI führt Standardprozesse autonom aus);
    H --> I(Mensch überwacht & greift bei Ausnahmen ein);
    I --> J[2030: Teilautonome Vergabe];
    J --> K(Mensch definiert Strategie & Ziele);
    K --> L(KI optimiert & führt aus);
...
## **8.2 Neue Horizonte: Nachhaltigkeit, Souveränität und Ethik als strategische Treiber**

Während wir heute noch primär über Effizienzsteigerung sprechen, werden in den kommenden Jahren drei weitere Dimensionen in den Mittelpunkt der KI-gestützten Vergabe rücken: Nachhaltigkeit, digitale Souveränität und **angewandte Ethik**. Diese werden nicht nur als "Nice-to-have" betrachtet, sondern als zwingende strategische Notwendigkeiten.
...
*   **Beschaffung von "grüner KI":** Gleichzeitig wird die Nachhaltigkeit der KI-Systeme selbst zu einem Vergabekriterium. Wir werden lernen, den Energieverbrauch von Algorithmen und Rechenzentren zu bewerten und Anbieter zu bevorzugen, die ressourcenschonende und energieeffiziente KI-Lösungen anbieten.
...
**3. Transparenz und Erklärbarkeit als ethische Notwendigkeit:**
...
*   **Automatisierte formale Prüfung:** Ein spezialisiertes KI-System (Stufe 3 aus Kapitel 2) kann Angebote auf Vollständigkeit und die Einhaltung formaler Kriterien prüfen. Aber auch ohne integriertes System können Sie die Analysefähigkeit nutzen, indem Sie die KI mit Ihren Checklisten und den digitalisierten Angeboten füttern.
    > **Praxis-Prompt:** "Hier ist eine Checkliste unserer formalen Anforderungen (z.B. 'Alle geforderten Formblätter unterschrieben?', 'Referenzen angegeben?', 'Preise an allen Positionen eingetragen?'). Hier ist das anonymisierte Angebot von Bieter A. Gehe die Checkliste Punkt für Punkt durch und gib an, ob der Punkt erfüllt ist oder nicht. Zitiere bei Erfüllung die entsprechende Seite im Angebot und bei Nicht-Erfüllung die Begründung."
